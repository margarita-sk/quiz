...
public class FailedAnswerUpdateProcessor implements UpdateProcessor {
    ...
    public void processUpdate(Update update) {
        ...
        var latestQuestionId = latestQuestionByChatId.get(chatId);
       quizExecutionService.updateFailedQuestion(latestQuestionId);

        var sendMessage = new SendMessage(chatId, "Try to remember it next time").parseMode(ParseMode.HTML);
